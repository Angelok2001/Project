...
namespace Progect.Controllers
{
    public class TypesController : Controller
    {
        ...
        public TypesController(ProgectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,TupeDescription")] Types types)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,TupeDescription")] Types types)
        {
            if (id != types.ID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProgectContext.Types'  is null.");
            }
            var types = await _context.Types.FindAsync(id);
            if (types != null)
            {
